...
namespace {
    ...
    const char* kPyScript =
        ...
        "\n"
        "\n"
        "def _pg_undo_begin(label):\n"
        "    # Nuke 17 rebound nuke.Undo through pybind11: the constructor no longer\n"
        "    # takes a name and the object is no longer a context manager. Try every\n"
        "    # spelling the different Nuke generations accept.\n"
        "    try:\n"
        ...
        "            undo = _pg_undo_begin('Bake Sample')\n"
        "            try:\n"
